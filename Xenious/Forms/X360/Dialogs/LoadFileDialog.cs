...
namespace Xenious.Forms.Dialogs
{
    partial class LoadFileDialog : Form
    {
        ...
        public XeCompressionType output_comp_type;
        public XeEncryptionType output_enc_type;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    output_enc_type = XeEncryptionType.Encrypted;
                    break;
                case 1:
                    output_enc_type = XeEncryptionType.NotEncrypted;
                    break;
            }
        }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    output_comp_type = XeCompressionType.Zeroed;
                    break;
                case 1:
                    output_comp_type = XeCompressionType.Raw;
                    break;
                case 2:
                    output_comp_type = XeCompressionType.Compressed;
                    break;
                case 3:
                    output_comp_type = XeCompressionType.DeltaCompressed;
                    break;
            }
        }
